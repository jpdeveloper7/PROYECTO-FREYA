...
import { onAuthStateChanged, deleteUser, signOut, reauthenticateWithCredential, EmailAuthProvider, updatePassword, updateEmail } from 'firebase/auth';
import { ref, uploadBytes, getDownloadURL } from 'firebase/storage';
import Header from './Header';
import Sidebar from './Sidebar';

// (ToggleSwitch eliminado porque no se estaba usando)
...
function Configuracion() {
  ...
  // (isDeleting eliminado porque no se estaba usando)
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(perfilRef, (docSnap) => {
      if (docSnap.exists()) {
        ...
        const cleanSecurityData = { ...(data.securityData || {}) };
